...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт 
	...
	СтруктураРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВКМ_СуммаЕжемесячнойАбоненсткойПлаты,
	|ВКМ_ДатаНачалаДействияДоговора,ВКМ_ДатаОкончанияДействияДоговора");
	
	АбонПлата = СтруктураРеквизитов.ВКМ_СуммаЕжемесячнойАбоненсткойПлаты;
	НачалоДействияДоговора = СтруктураРеквизитов.ВКМ_ДатаНачалаДействияДоговора;
	ОкончаниеДействияДоговора = КонецДня(СтруктураРеквизитов.ВКМ_ДатаОкончанияДействияДоговора);
